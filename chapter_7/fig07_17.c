...
int main(void) {
    ...
    printf("    sizeof c = %lu\tsizeof(char) = %lu"
            ...
            "\n     sizeof array = %lu"
            "\n     sizeof ptr = %lu\n",
            sizeof c, sizeof(char), sizeof s, sizeof(short), sizeof i, sizeof(int), sizeof l, sizeof(long), sizeof ll, sizeof(long long), sizeof f, sizeof(float), sizeof d, sizeof(double), sizeof ld, sizeof(long double), sizeof array, sizeof ptr);
